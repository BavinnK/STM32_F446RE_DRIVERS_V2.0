...
C_SRCS += \
../Core/DRIVERS_V2.0/EXTI/EXTI.c 

OBJS += \
./Core/DRIVERS_V2.0/EXTI/EXTI.o 

C_DEPS += \
./Core/DRIVERS_V2.0/EXTI/EXTI.d 


# Each subdirectory must supply rules for building sources it contributes
Core/DRIVERS_V2.0/EXTI/%.o Core/DRIVERS_V2.0/EXTI/%.su Core/DRIVERS_V2.0/EXTI/%.cyclo: ../Core/DRIVERS_V2.0/EXTI/%.c Core/DRIVERS_V2.0/EXTI/subdir.mk
...
clean: clean-Core-2f-DRIVERS_V2-2e-0-2f-EXTI

clean-Core-2f-DRIVERS_V2-2e-0-2f-EXTI:
	-$(RM) ./Core/DRIVERS_V2.0/EXTI/EXTI.cyclo ./Core/DRIVERS_V2.0/EXTI/EXTI.d ./Core/DRIVERS_V2.0/EXTI/EXTI.o ./Core/DRIVERS_V2.0/EXTI/EXTI.su

.PHONY: clean-Core-2f-DRIVERS_V2-2e-0-2f-EXTI
