...
C_SRCS += \
../Core/DRIVERS_V2.0/DMA/DMA.c 

OBJS += \
./Core/DRIVERS_V2.0/DMA/DMA.o 

C_DEPS += \
./Core/DRIVERS_V2.0/DMA/DMA.d 


# Each subdirectory must supply rules for building sources it contributes
Core/DRIVERS_V2.0/DMA/%.o Core/DRIVERS_V2.0/DMA/%.su Core/DRIVERS_V2.0/DMA/%.cyclo: ../Core/DRIVERS_V2.0/DMA/%.c Core/DRIVERS_V2.0/DMA/subdir.mk
...
clean: clean-Core-2f-DRIVERS_V2-2e-0-2f-DMA

clean-Core-2f-DRIVERS_V2-2e-0-2f-DMA:
	-$(RM) ./Core/DRIVERS_V2.0/DMA/DMA.cyclo ./Core/DRIVERS_V2.0/DMA/DMA.d ./Core/DRIVERS_V2.0/DMA/DMA.o ./Core/DRIVERS_V2.0/DMA/DMA.su

.PHONY: clean-Core-2f-DRIVERS_V2-2e-0-2f-DMA
